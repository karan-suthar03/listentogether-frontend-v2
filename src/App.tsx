...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-300 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20 bg-gradient-radial from-gray-900 via-black to-black animate-pulse-slow"></div>      {/* Desktop: Two-section layout, Mobile: Single section, Ultra-wide: Three sections */}
